...
Para lograrlo, deberds definir dos atributos: el numerador y el denominador.

Ademas, implementards métodos correspondientes para cada operación, devolviendo un objeto
...
const createFractionWithFunctions = (numerator: number, denominator: number): FractionWithOperations => {
  ...
  return {
    ...
    substract: (f2: Fraction) => subtract(f1, f2),
